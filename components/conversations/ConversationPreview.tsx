...
export default function ConversationPreview({
  ...
  const getStatusMessage = (): {
    ...
    if (isCompleted) {
      ...
      return {
        icon: <XCircle className="h-3 w-3 mr-2 text-red-600" />,
  ...
  return (
    <ConversationWrapper>
      <Card
        className={`overflow-hidden transition-all shadow-md hover:shadow-md font-rubik ${getCardStyles()}`}
      >
        <CardContent
          className={`px-3 pt-4 pb-2 relative ${
        ...
        >
          ...
          {isOngoing && (
            <Badge
              ...
              className={`shadow-sm absolute top-0 left-0 rounded-tr-none rounded-bl-none z-10 text-[11px] ${
                userRole === "seller"
          ...
          <div className={`flex relative ${isOngoing ? "pt-3" : "pt-0"}`}>
            ...
            <div className="relative">
              <div className="flex-shrink-0">
                {item && item.images && item.images.length > 0 ? (
                  <div className="h-[60px] w-[60px] rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                    <img
            ...
            <div className="flex-1 min-w-0 pl-4">
              ...
              <div className="flex justify-between items-center gap-2">
                ...
                <span className="text-[12px] text-gray-500 whitespace-nowrap flex items-center">
              ...
              {!isOngoing && statusInfo.text && (
                <div
                  className={`flex items-center text-[10px] pl-2 py-1 rounded-md border mt-1 mb-1 ${statusInfo.className}`}
                >
                  {statusInfo.icon}
              ...
              {!isCancelled && isOngoing && (
                ...
                >
                  ...
                  <p className="truncate text-[10px] mb-[2px] text-gray-600">
                    {getPreviewText()}
                  </p>
                </div>
              )}
